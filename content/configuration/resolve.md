...
W> Using this will **override the default array**, meaning that webpack will no longer try to resolve modules using the default extensions. This option no longer requires passing an empty string. This behavior was moved to **resolve.enforceExtension**.
